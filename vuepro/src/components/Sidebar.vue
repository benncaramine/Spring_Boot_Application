<template>
	<aside :class="`${is_expanded ? 'is-expanded' : ''}` ">
		...
		<h3>Menu</h3>
		<div class="menu">
			<router-link to="/employe/home" class="button">
				<span class="material-icons">home</span>
				<span class="text">Accueil</span>
			</router-link>
			<router-link to="/employe/doc" class="button">
			<span class="material-icons">description</span>
			<span class="text">Documents</span>
			</router-link>
			<router-link to="/employe/emprunt" class="button">
				<span class="material-icons">folder_open</span>
				<span class="text">Emprunt</span>
			</router-link>
			<router-link to="/employe/postinfo" class="button">
				<span class="material-icons">laptop_mac</span>
				<span class="text">Poste</span>
			</router-link>
			<router-link to="/employe/abonnement" class="button">
				<span class="material-icons">subscriptions</span>
				<span class="text">Abonnement</span>
			</router-link>
			<router-link to="/employe/lecteur" class="button">
				<span class="material-icons">group</span>
				<span class="text">Lecteur</span>
			</router-link>
			<router-link to="/employe/retour" class="button">
				<span class="material-icons">assignment_return</span>
				<span class="text">Retour Document</span>
			</router-link>
			<router-link to="/employe/profil" class="button">
