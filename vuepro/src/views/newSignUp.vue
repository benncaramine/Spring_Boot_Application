<template>
  ...
  export default {
    ...
    setup() {
      ...
      const register = () => {
        axios.post('http://localhost:8081/user/enregistrerLecteur', {
          solde: 100, // La valeur du solde est fixe à 100 dans votre code
        ...
        .catch(error => {
          // Affichage du message d'erreur en cas d'échec de l'enregistrement
  ...
  .error-message {
    ...
    margin-top: 10px; /* Marge en haut pour l'éloigner des autres éléments */
  }
  </style>
